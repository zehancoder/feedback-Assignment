...
export const Cards =({img, heading, text, stars, rating, review, className, animateText}) => {
    return (
        <>
            <div className={cn("bg-whiteGray rounded-[12px] w-72 font-roboto", className)}>
                ...
                <div className="p-3">
                    ...
                    <p className="text-xs md:text-[14px] text-darkGray mt-2 leading-[16.14px]">{text}</p>
